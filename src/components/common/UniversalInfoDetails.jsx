    ...
    <>
      ...
      {open && (
        <motion.div
          ...
          onClick={handleClose}
          className={`fixed inset-0 z-50 h-full ${backdrop ? "bg-black/40" : ""
            }`}
        >
          <motion.div
            id="drawer"
            ...
            transition={transitionConfig}
            className={`absolute ${position === "bottom" ? "bottom-0 w-full" : "right-0 h-full"
              } overflow-hidden bg-white shadow-xl ${rounded && position === "bottom" ? "rounded-t-3xl" : ""
              }`}
          ...
          >
            ...
            {/* Drawer Content */}
            <div className="relative h-full overflow-y-auto p-3 pt-5 whitespace-pre-line leading-relaxed text-[0.95rem] text-gray-700">
